...
int main()
{
	...
	pointLights[1] = PointLight(
		...
		-15.0f, -1.0f, -4.0f,  // posición x, y, z
	...
	while (!mainWindow.getShouldClose())
	{
		...
		glm::vec3 lightOffset = glm::vec3(0.0f, 0.0f, 4.3f);
		glm::vec3 lightPos = carPos + lightOffset;
		spotLights[2].SetPos(lightPos);
		// Se usa forwardDirection para apuntar el spot en la dirección delantera del coche.
