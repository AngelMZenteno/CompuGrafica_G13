...
public:
	...
	GLfloat getWheelRotation() { return wheelRotation; } */
	bool prendida;
	//bool haciaArriba;
	bool estaMoviendoAdelante() { return MoviendoAdelante; }
	bool getPosteDeLuzOn() { return posteDeLuzOn; }
	bool getHongoOn() { return hongoOn; }
	bool getPuertasAbiertas() { return puertasAbiertas; }
